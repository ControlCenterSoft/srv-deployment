...
install -m 0644 "$PAYLOAD/app/core/network.py" "$PROJECT/app/core/network.py"
install -m 0644 "$PAYLOAD/app/core/network_plan.py" "$PROJECT/app/core/network_plan.py"
install -m 0644 "$PAYLOAD/app/routers/api.py" "$PROJECT/app/routers/api.py"
install -m 0644 "$PAYLOAD/templates/internet.html" "$PROJECT/templates/internet.html"
install -m 0644 "$PAYLOAD/static/js/internet.js" "$PROJECT/static/js/internet.js"
install -m 0644 "$PAYLOAD/static/css/network.css" "$PROJECT/static/css/network.css"
