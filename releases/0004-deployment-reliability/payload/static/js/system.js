(() => {
    ...
    async function refresh() {
        try {
            ...
            if (!metricsResponse.ok || !healthResponse.ok || !metricsPayload.ok || !healthPayload.ok) {
            ...
            setText("systemGitHubSync", formatSyncTime(release.synced_at));
            ...
            setText("deploymentFinished", formatSyncTime(deployment.deployment_finished_at || release.synced_at));
            setText("deploymentHealthchecked", formatSyncTime(deployment.healthchecked_at));
