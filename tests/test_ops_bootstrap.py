...
class OpsBootstrapTests(unittest.TestCase):
    ...
    def test_private_source_is_pinned_to_exact_commit(self):
        ...
        self.assertEqual("3ea5c4124d4eda8f048c1a6e8bd40f2f5e2f5d57", match.group(1))
    ...
    def test_all_bootstrap_files_have_exact_pinned_git_blob_ids(self):
        expected = {
            ...
            "agent/ccops_agent_v3.py": "219622f0750794eda9beea7a94f4c2f153e9dbcf",
            "agent/ccops_broker.py": "de14cd6b0686d7fdd09fc76adbdc40db2cb17085",
            "agent/ccops_socket_broker.py": "15903ccc2c94aa5ba96ec076732ce38c347ab680",
    ...
    def test_installs_accepted_remote_agent_1_1_6_bundle(self):
        ...
        self.assertIn("REMOTE_AGENT_RELEASE=1.1.6", self.text)
        self.assertIn("OPS_AGENT_VERSION=1.1.6", self.text)
        self.assertIn("BROKER_CORE_VERSION=1.1.5", self.text)
        self.assertIn("BROKER_TRANSPORT_VERSION=1.1.6", self.text)
    ...
    def test_registration_contract_matches_accepted_agent(self):
        self.assertIn("payload.get('agent_version') == '1.1.6'", self.text)
